...
(async function () {
	...
	logger(`${api.getCurrentUserID()} - [ ${global.config.PREFIX} ] • ${(!global.config.BOTNAME) ? "This bot was made by CatalizCS and SpermLord FIXING FILE CHORU TIKTOKERS AND CYPRUS RECREATE" : global.config.BOTNAME}`, "[ BOT INFO ]");
	...
	const checkTime = (time) => new Promise((resolve) => {
		...
		if (time[2] < 2023) resolve("In what era do you live in?");
